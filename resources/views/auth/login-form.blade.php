...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Login - Sistem Inventaris Desa</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="title" content="Login - Sistem Inventaris Desa">
    <meta name="description" content="Sistem Inventaris Desa - Admin Dashboard">
    <meta name="keywords" content="sistem inventaris, desa, admin dashboard" />
                        ...
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center mb-4">
                                <div class="brand-logo">
                                    <img src="{{ asset('assets-admin/img/logo/desa-inventaris-logo.png') }}"
                                         alt="DESA INVENTARIS"
                                         style="max-width: 180px; height: auto;">
                                </div>
                            </div>
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">Sign in to Sistem Inventaris Desa</h1>
                            </div>
                            ...
                            <form action="{{ route('auth.login.form') }}" method="POST" class="mt-4">
                                @csrf
                                <!-- Form -->
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    Not registered?
                                    <a href="{{ route('auth.register.form') }}" class="fw-bold">Create account</a>
                                </span>
                            </div>
                        </div>
                    </div>
