...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Register - Sistem Inventaris Desa</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="title" content="Register - Sistem Inventaris Desa">
    <meta name="description" content="Sistem Inventaris Desa - Register Account">
    <meta name="keywords" content="sistem inventaris, desa, register account" />
...
<body>
    ...
    <main>
        ...
        <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
            <div class="container">
                <p class="text-center">
                    <a href="{{ route('auth.login.form') }}" class="d-flex align-items-center justify-content-center">
                ...
                <div class="row justify-content-center form-bg-image" data-background-lg="{{ asset('assets-admin/img/illustrations/signin.svg') }}">
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500 form-container">
                            ...
                            <form action="{{ route('auth.register.form') }}" method="POST" class="mt-4">
                                @csrf

                                <!-- Nama dan Tanggal Lahir dalam satu baris -->
                                <div class="row g-3 mb-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @enderror
                                            <small class="form-text text-muted">Tidak boleh mengandung angka</small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    @error('alamat')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">Maksimal 300 karakter</small>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @error('password')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                            <small class="form-text text-muted">Minimal 6 karakter, harus mengandung huruf kapital dan angka</small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    <div class="form-check">
                                        <input class="form-check-input @error('agree_terms') is-invalid @enderror"
                                               ...
                                               required>
                                        <label class="form-check-label fw-normal mb-0" for="agree_terms">
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    ...
                                    <a href="{{ route('auth.login.form') }}" class="fw-bold">Login here</a>
                                </span>
                            </div>
                        </div>
                    </div>
